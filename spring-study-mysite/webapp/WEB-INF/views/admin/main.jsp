			...
			<div id="content">
				<div id="site-form">
					<form method="post" action="${pageContext.request.contextPath }/admin/main/update" enctype="multipart/form-data" >
						...
						<img id="profile" onerror="this.src='${pageContext.request.contextPath }/assets/images/default_profile.png'" 
						src="${pageContext.request.contextPath }/${siteVo.profile }"  style="width:120px;">
